...
echo ========================================
Powershell.exe -executionpolicy remotesigned -File build.ps1 --configuration=Release --framework=net8.0-windows --runtime=win-x64 --selfcontained=false --publishdir=../Release --publishexename="%appname%"
echo.
echo ========================================
echo Artifact
echo ========================================
